...
export const store = ({}, form) => {
    return Vue.request(form).post('/api/projects', 'projects/add').then(() => {
...
export const update = ({}, data) => {
    return Vue.request(data).post('/api/projects/' + data.project, 'projects/update').then(() => {
...
export const destroy = ({}, project) => {
    return Vue.request(project).delete('/api/projects/' + project, 'projects/remove').then(() => {
