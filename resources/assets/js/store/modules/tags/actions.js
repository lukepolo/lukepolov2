...
export const store = ({}, form) => {
    return Vue.request(form).post('/api/tags', 'tags/add').then(() => {
...
export const update = ({}, form) => {
    return Vue.request(form).put('/api/tags/' + form.tag, 'tags/update').then(() => {
...
export const destroy = ({}, tag) => {
    return Vue.request(tag).delete('/api/tags/' + tag, 'tags/remove').then(() => {
