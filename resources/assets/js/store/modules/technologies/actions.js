...
export const store = ({}, form) => {
    return Vue.request(form).post('/api/technologies', 'technologies/add').then(() => {
...
export const update = ({}, form) => {
    return Vue.request(form).put('/api/technologies/' + form.technology, 'technologies/update').then(() => {
...
export const destroy = ({}, technologies) => {
    return Vue.request(technologies).delete('/api/technologies/' + technologies, 'technologies/remove').then(() => {
