...
export const store = ({}, data) => {
  return Vue.request(data)
    .post("/api/timelines", "timelines/add")
    .then(() => {
...
export const update = ({}, form) => {
  return Vue.request(form)
    .put("/api/timelines/" + form.timeline, "timelines/update")
    .then(() => {
...
export const destroy = ({}, timeline) => {
  return Vue.request(timeline)
    .delete("/api/timelines/" + timeline, "timelines/remove")
    .then(() => {
