  ...
  <div class="container">
    <div class="col-md-12 big-bottom-padding" v-if="blog">
      <h1 class="blog-name">
        ...
        <router-link
          :to="{ name: 'admin-blogs-edit', params: { blog: blog.id } }"
      ...
      <small> createdDateDisplay </small><br />
      ...
      <hr />
      <img
        class="img-responsive blog-image center-block"
        :src="blog.blog_image"
      />
...
import blogDatesMixin from "@views/blog/mixins/blogDatesMixin";
export default {
  mixins: [blogDatesMixin],
  components: {
    CommentsArea,
  },
  props: {
  ...
  created() {
    ...
    //         })
    //     })
    this.$store.dispatch("blogs/get", blog);
  },
  computed: {
    blog() {
